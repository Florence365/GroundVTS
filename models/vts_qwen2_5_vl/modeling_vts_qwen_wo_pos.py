...
class VTS_Qwen2_5_VL(Qwen2_5_VLForConditionalGeneration):
    """VTS variant without position-id recomputation after token selection."""
    ...
    def forward(
        ...
        """
        Forward pass with integrated VTS module (without position-id recomputation).
        """
        ...
        # Skip position_ids recomputation in this variant — use attention mask only
        if self.hard_select:
