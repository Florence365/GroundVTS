    ...
    def _regularize_videos(self, videos: list["VideoInput"], **kwargs) -> dict[str, list[list["ImageObject"]]]:
        ...
        for video in videos:
            ...
            if _check_video_is_nested_images(video):
                ...
                except (av.error.InvalidDataError, av.error.ValueError, av.error.OSError) as e:
                    print(f"Warning: Video decoding failed - file: {video}, error: {e}")
                    frames = []

                except Exception as e:
                    print(f"Warning: Unexpected error processing video - file: {video}, error: {e}")
                    frames = []
